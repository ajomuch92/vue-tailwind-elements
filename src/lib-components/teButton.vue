...
export default {
  ...
  computed: {
    getClass() {
      return {
        'bg-gray-500 active:bg-gray-500 text-white': this.type === 'normal' && !this.onlyText && !this.outlined,
        'bg-indigo-500 active:bg-indigo-500 text-white': this.type === 'primary' && !this.onlyText && !this.outlined,
        'bg-green-500 active:bg-green-500 text-white': this.type === 'success' && !this.onlyText && !this.outlined,
        'bg-blue-500 active:bg-blue-500 text-white': this.type === 'info' && !this.onlyText && !this.outlined,
        'bg-yellow-500 active:bg-yellow-500 text-white': this.type === 'warning' && !this.onlyText && !this.outlined,
        'bg-red-500 active:bg-red-500 text-white': this.type === 'danger' && !this.onlyText && !this.outlined,
        'bg-purple-500 active:bg-purple-500 text-white': this.type === 'purple' && !this.onlyText && !this.outlined,
        'bg-pink-500 active:bg-pink-500 text-white': this.type === 'pink' && !this.onlyText && !this.outlined,
        'background-transparent text-gray-500': this.type === 'normal' && this.onlyText && !this.outlined,
        'background-transparent text-indigo-500': this.type === 'primary' && this.onlyText && !this.outlined,
        'background-transparent text-green-500': this.type === 'success' && this.onlyText && !this.outlined,
        'background-transparent text-blue-500': this.type === 'info' && this.onlyText && !this.outlined,
        ...
        'bg-transparent border border-solid border-indigo-500 text-indigo-500 hover:bg-indigo-500 hover:text-white': this.type === 'primary' && this.outlined,
        ...
        'bg-transparent border border-solid border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white': this.type === 'info' && this.outlined,
